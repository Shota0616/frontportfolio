...
$Referer_check_domain = "https://shotaisoda.com/";
...
$thanksPage = "https://shotaisoda.com";
...
$require = array('氏名','メールアドレス','お問い合わせ内容');
...
//配列の形「name="○○[]"」の場合には必ず後ろの[]を取ったものを指定して下さい。
$hankaku_array = array('メールアドレス','お問い合わせ内容');
...
<title>確認画面</title>
<!-- googlefont -->
<link href="https://fonts.googleapis.com/css2?family=Noto+Serif+JP:wght@400;600;700&family=Open+Sans:wght@300;400;600;700&display=swap" rel="stylesheet">
<!-- Custom css -->
